...
- Reparar caché con registro de aplicación al cargar Autenticación Open ID

## Contexto

- Caché con registro de aplicación al cargar Autenticación Open ID

## Detalle Técnico

- Fix Cache with Application Registration at load Open ID Authentication.
